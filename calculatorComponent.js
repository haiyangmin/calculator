...
class CalculatorContainer extends Component {
    ...
    render() {
        return (<div className="container">
            ...
            <p style={ { margin: 40, textAlign: 'center' } }>Below "P" is the operator to get the largest prime number
                between A and B, for example, 1P9 return largest prime number 7 between 1 and 9</p>
